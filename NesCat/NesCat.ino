...
//*                                                                              *
//*   Requirements: ESP32 , SD7789 LCD, MICROSD CARD slot,          
...
#define PIN_DOWN   12  //IO35
#define PIN_LEFT   36  //SVP
#define PIN_RIGHT  34  //IO34
#define PIN_A      15   //I2
#define PIN_B      14  //14
#define PIN_START  2 //15
#define PIN_SELECT 13  //13
///!!! do not forget 1KOHM resistors

#define KEYBOARD_DATA 3  /// ---[ 1K ]--- // -D
...
//--------------------------------------------------------------------------------
  ...
  draw_string("NesCat mini project");
  delay(500);
